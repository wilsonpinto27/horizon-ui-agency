  ...
  return (
    <section id="about" className="py-16 md:py-24 bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold font-display mb-4 text-white">About PixelCraft Studio</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-16 md:mb-24">
          {stats.map((stat, index) => (
            ...
            >
              <div className="font-bold text-4xl md:text-5xl text-blue-400 mb-2">{stat.value}</div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-16 md:mb-24">
          <motion.div
            className="bg-blue-900/20 p-8 rounded-lg border border-blue-800/20"
            initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
          >
            <h3 className="text-2xl font-bold mb-4 font-display text-white">Our Mission</h3>
          ...
          <motion.div
            className="bg-purple-900/20 p-8 rounded-lg border border-purple-800/20"
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
          >
            <h3 className="text-2xl font-bold mb-4 font-display text-white">Our Vision</h3>
            <p className="text-gray-300">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="mb-4 p-3 bg-blue-900/20 rounded-full border border-blue-800/20">
                {feature.icon}
              </div>
              <h3 className="text-xl font-bold mb-2 font-display text-white">{feature.title}</h3>
